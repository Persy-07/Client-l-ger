    ...
    if (isset($_FILES['photo']) && !$_FILES['photo']['error']) { //vérifie si le champs photo n'est pas vide 
        ...
        if ($_FILES['photo']['size'] <= 2000000) {
            if (in_array($fileInfo['extension'], $extensions)) {
                ...
                $time = time();
                $req= $pdo->prepare("insert into annonce values (null,:titre,:vendeur,now(),:detail,:chemin,:categorie,:prix,:etat,0,:livraison,0,:time)"); //requête qui insert dans la bdd les infos saisies dans le formulaire
                $req->execute(array(
                    "titre"=>$titre,
                    "vendeur"=>$vendeur,
                    "detail"=>$detail,
...
<html lang="fr">
<head>
    <title>Nouvelle annonce - Furniture Annonce</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form enctype="multipart/form-data" action="" method="post"> <!--Formulaire d'ajout d'annonce-->
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label" for="etat">Selectionnez l'état de votre Annonce</label>
                                    ...
                                    <input type="radio" name="livraison" value="1"required>Livraison.
                                     ...
                                     <input type="radio" name="livraison" value="0">Remise en Main Propre.
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <label class="form-check-label" for="flexCheckChecked">J'accepte les conditions général d'utilisateur, les règles de diffusion du site lebon accessoire et j'autorise a diffuser mon annonce.
                                        </label>
                                    </div>
